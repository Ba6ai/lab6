...
<<<<<<< HEAD
#### Создаются переменные типа double x1, y1, x2, y2; пользователь вводит значения в эти переменные(проверка ввода цифр осуществляется через TryParse), создаются 2 объекта класса Point с присваиванием значений из переменных. Вывод расстояния между двумя точками через формулу.
=======
#### Реализация ввода такая же как и в первой задаче с проверкой ввода TryParse, но поля теперь double. Объявляю создание точек Point p2 с значениями x1, y1 и такую же Point p2 с значениями x2, y2 "Point p1 = new Point(x1, y1);"
>>>>>>> c2cd50850b3b9cf475e4f7cb41d827676c18a681
